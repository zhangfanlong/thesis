...
综上所述，当系统中存在的克隆代码片段在发生变化时，一个值得研究的问题是如何避免由克隆变化所导致的克隆一致性违背缺陷（Consistency Defect）。如果克隆代码的变化会引发一致性违背缺陷，警告软件开发人员对变化所在的克隆组进行一致性维护。如果克隆代码的变化不会引发一致性违背缺陷，则通知开发人员可以自信的且自由的修改克隆代码，从而可以更快地进行软件开发过程。因此，可以帮助程序开发人员避免一致性违背缺陷，提高软件质量和可维护性。
