...
综上，当软件中的克隆代码发生变化时，由于克隆组内的克隆片段的相似性，该变化可能会引发克隆组的一致性变化。遗忘一致性变化会导致克隆代码的一致性违背缺陷（Consistency Defect），从而降低软件系统的质量和可维护性。在软件开发过程中，判断克隆代码的变化是否会引发一致性变化，可以帮助开发人员避免一致性违背缺陷。因此，结合软件开发过程，在克隆代码发生变化时，预测克隆代码的一致性维护需求是一个值得研究的问题，可以帮助开发人员边开发、边维护克隆代码，提高软件质量和可维护性。如果克隆代码的变化会引发一致性违背缺陷，警告软件开发人员对变化所在的克隆组进行一致性维护。如果克隆代码的变化不会引发一致性违背缺陷，则通知开发人员可以自信的且自由的修改克隆代码，可以更快地对软件开发和维护。
