...
克隆变化实例收集如算法~\ref{alg-collectionchanging}~所示。
...
{ 
 ...
 Mapping all the $CFs$ and $CGs$ between the adjacent versions {V\_i} and {V\_{i+1}}\;
  Identify all clone evolution pattern in thus two versions according to Definition~\ref{def-evolutionpattern}~\;
...
\KwIn{All clone changing instances with number $N$}
