...
综述所述，如何在克隆代码产生时避免克隆代码所导致的额外维护代价是一个值得研究的问题，即避免可能导致额外维护代价的克隆代码的产生，以降低软件的维护代价；并且同时允许不会导致额外维护代价的克隆代码的产生，以提高软件的开发效率。该研究可以帮助程序开发人员避免额外的维护代价，提高软件质量和可维护性。
...
（3）在预测克隆创建一致性维护需求时，如何结合软件开发过程，帮助程序开发人员避免额外的维护代价？（a）不同的机器学习方法是否具有相似的预测能力？（b）并且所构建的模型对于两种不用的克隆创建实例，是否具有一致的预测能力？
