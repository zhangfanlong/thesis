...
为了提高软件开发效率和节约开发时间，复用既有代码已成为了一种常见的软件开发手段。但是，代码复用会向系统中引入大量的克隆代码，同时系统中的克隆代码不是静止不变的，会随着软件版本的更新而演化，研究人员将克隆代码的这一过程称之为克隆代码演化。
%克隆代码的存在及其演化过程会对软件系统产生一定的影响。通过分析克隆代码的存在和演化信息，可以帮助程序人员理解克隆代码，甚至帮助维护克隆代码。
...
\BiSection{克隆演化特征定义}{The Definition for Code Clone Evolutionary Characteristics}

%\BiSection{问题描述}{Research Problem}
...
%克隆代码是根据某种相似性定义彼此相似的代码片段的集合\cite{roy2007survey}。它们在软件系统中比例占到7\%~23\%，甚至在某些软件中达到59\%\cite{koschke2007survey}。
