...
（3）如何全面且客观地分析和挖掘克隆代码演化特征，并帮助开发人员理解和维护软件中克隆代码？（a）克隆代码在其演化过程中，是否是稳定的，是否容易发生变化？（b）软件中是否存在大量的发生变化的克隆代码，并且其在演化过程中是如何发生变化的？
