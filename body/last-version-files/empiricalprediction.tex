...
\BiSubsection{项目内克隆一致性需求预测}
{Clone Consistency-Requirement for Within Project}


\BiSubsubsection{克隆创建时一致性预测}
...
\BiSubsection{跨项目克隆代码一致性预测实验}
{Clone Consistency Prediction Experiment}

本节给出跨项目预测的实验结果。

\BiSubsubsection{跨项目克隆创建时一致性预测}
{Clone Creating Consistency Prediction Cross-Project}

\BiSubsubsection{跨项目克隆变化时一致性预测}
{Clone Changing Consistency Prediction Cross-Project}
