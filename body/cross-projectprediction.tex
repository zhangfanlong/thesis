...
对克隆代码变化实例，使用五种不同的机器学习方法进行跨项目预测，实验结果如~\ref{changingcrossmethodaverage}~所示。表中支持向量机的实验结果使用{*}标记，原因同样是支持向量机将所有的克隆变化实例划分到同一个类别中（规模比较大的类别中）。
...
从表中可以看出，其它的四种机器学习方法对所测试项目的预测效果一般。并且彼此之间也不存在显著的差异。分析其预测能力一般的原因，可能是系统中存在的克隆变化实例较少，而项目之间的克隆代码变化也千差万别，所构建的跨项目预测模型并不具有较强的泛化能力。
...
结合上一节的贝叶斯网络方法的实验结果，在跨项目的预测中，不推荐程序开发人员选用支持向量机的方法；但依然可以使用其它的机器学习方法进行跨项目一致性预测，但需要根据项目自身特征，去选择所预测的类别（样本不平衡），即预测数量较多的克隆变化实例类别；在对不同的软件系统进行预测时，程序开发人员可以根据预测结果选择最合适的机器学习方法。
...
\begin{table} [h]
\bicaption[creatingcrosssizeaverage]{}{克隆创建实例的跨项目数据集规模实验}
...
\midrule[1pt]
\multirow{5}{*}{平均Precision(\%)}
&BN&63.3&63.8&81&81.2&55.6&57.5&63.3&64.8\\
...
&DT&68.6&62.9&78.2&79.6&	53&56.6&59.4&70.4\\
\hline
\multirow{5}{*}{平均Recall(\%)}															
&BN&67&67.5&75.2&84.4&60.6&60.2&67.4&69.8\\
&NB&66.9&69.3&75.4&74.7&56.4&54&64.3&64.7\\
&SVM&80.9&77.1&88.5&88.5&59.8&59.8&71.1&71.1\\
&KNN&68.1&68.7&76.2&74.1&63.5&64.9&65.5&66.3\\
&DT	&76.4&74&80.3&84.4&59.5&59.9&68.8&73.1\\
\hline
\multirow{5}{*}{平均F-measure(\%)}					
&BN&64.5&65.4&76.8&82.6&51.6&50.8&63.1&65\\
