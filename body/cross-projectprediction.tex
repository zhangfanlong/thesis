...
同时，在本文第三章和第四章中，仅给出了克隆一致性维护需求的预测方法，并没有结合结合软件开发过程，帮助程序开发人员进行克隆代码的一致性维护需求的预测。因此，针对如何结合软件开发过程，帮助开发人员边开发、边维护克隆代码，从而提高软件质量和可维护性。

综上所述，本章的研究问题为：在某一软件系统开发的早期阶段，由于缺乏自身训练数据，如何使用跨项目的数据（其它项目数据）对克隆代码进行一致性维护是一个值得研究的问题，即如何在软件开发初期避免克隆代码的额外维护代价并且避免克隆一致性违背缺陷。同时，如何结合软件开发过程，执行克隆代码的一致性维护也是一个值得研究的问题。该研究可以帮助程序开发人员在软件开发初期，避免克隆代码所导致的额外的维护代价和一致性违背缺陷，从而可以提高软件质量和可维护性。
