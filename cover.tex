...
We call the earliest code clone in software as ``clone creating instance'', and call that of whether creating instance will occur consistent change in its future evolution as ``clone creating consistency-requirement''.
...
In this thesis, we call the changed clone code as ``clone changing instance'', and call that of whether such changes will lead to consistent change that occurs to changing instance as ``clone changing consistency-requirement''.
