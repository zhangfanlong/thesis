...
\cabstract{
%%背景知识
研究表明软件系统中存在大量的克隆代码，即根据某种相似度彼此相似的代码片段。为了有效地检测克隆代码，研究人员提出和开发了许多中不同的克隆代码检测方法和工具。研究人员将克隆代码视为一种“代码坏味”，其存在可能会影响软件质量、可理解性和可维护性。在软件系统随时间演化的过程中，克隆代码也会随着软件系统进行演化，这一过程可以使用克隆家系来描述。在克隆代码的演化过程中，克隆代码往往表现出一些特征，本文称之为克隆代码演化特征。其中，引发研究人员强烈关注的是克隆代码在演化过程中的变化，即一致性变化和不一致变化。克隆的变化会导致与之相关的克隆缺陷以及额外的维护代价，从而降低软件质量。因此，本文在软件演化的基础上研究克隆代码的分析和维护方法，旨在帮助软件开发和维护人员理解和维护克隆代码，从而帮助提高软件质量和可维护性。

%%研究内容
具体地，本文研究基于机器学习的克隆代码分析和维护方法，通过提取与克隆代码相关的度量值表示克隆代码，并结合相关的机器学习方法帮助解决克隆代码的分析和维护问题。
...
进一步地，为帮助程序人员选择合理的一致性需求预测模型，

%%实证研究
本文还进行了克隆一致性维护需求的实证研究。将克隆代码的一致性维护预测扩展到其它的机器学习方法中， 并给出了相应的建议指导开发人员进行选择。同时，还对比了复制粘贴时和克隆变化时的预测，也给出了相关的建议。
