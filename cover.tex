...
\newcommand{\chinesethesistitle}{基于软件演化和机器学习的克隆代码分析与一致性维护方法研究} %授权书用，无需断行
\newcommand{\englishthesistitle}{\uppercase{RESEARCH ON CODE CLONE ANALYSIS AND CONSISTENCY MAINTENANCE BASED ON SOFTWARE EVOLUTION AND MACHINE LEARNING}} %\uppercase作用：将英文标题字母全部大写；
\newcommand{\chinesethesistime}{2017 年~6月}  %封面底部的日期中文形式
\newcommand{\englishthesistime}{June, 2017}    %封面底部的日期英文形式

\ctitle{基于软件演化和机器学习的克隆代码分析与一致性维护方法研究}  %封面用论文标题，自己可手动断行
...
在克隆代码随系统演化的过程中，克隆代码及其演化过程往往会表现出一些特征，本文称之为克隆代码演化特征。其中，引发研究人员强烈关注的是克隆代码在演化过程中的变化情况，即一致性变化和不一致性变化。克隆变化可能会导致与之相关的克隆代码一致性缺陷以及额外的维护代价，从而降低软件质量和可维护性。因此，本文在克隆代码演化的基础上结合机器学习方法研究克隆代码分析和一致性维护方法，通过提取分析克隆代码的演化特征分析，帮助程序开发人员理解克隆代码，通过预测克隆代码的一致性维护需求解决克隆代码的一致性维护问题，帮助程序开发人员维护克隆代码。
